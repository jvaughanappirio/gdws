...
public class GDWebServiceImp implements GDWebService {
	...
	public QMaster getQMasterTable(@WebParam(name = "QMasterKey") Integer QMasterKey)
	{
		try {
	...
	public CustomerInformation getCustomerByActNum(@WebParam(name = "CustomerKey") Integer CustomerKey)
	{
		try {
...
public class GDWebServiceImp implements GDWebService {
	...
	public CustomerInformation getCustomerInfo(@WebParam(name = "firstname") String firstname, @WebParam(name = "lastname") String lastname) {
		try {
			CustomerInformation ci = new CustomerInformation();
			ci.FirstName = firstname;
			ci.LastName = lastname;
			ci.Street = "1234 Main St";
			ci.City = "Los Angeles";
			ci.State = "CA";
			ci.Zip = "90001";
			ci.Country = "USA";
			ci.Phone = "(555) 555-1234";
			return ci;
		}
		catch (Exception ex)
		{
	...
	public QMaster getQMasterTable(@WebParam(name = "QMasterKey") Integer QMasterKey)
	{
		try {
			...
			qm.VirtualPilot = 7777;
			qm.QMasterScriptKey = 8888;
			qm.UsherScript = "UsherScriptNATE";
			//throw new Exception();
			return qm;
		}
		catch (Exception ex)
